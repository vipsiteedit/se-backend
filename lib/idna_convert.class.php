...
class idna_convert
{
     ...
     * @return string
     */
    private function _ucs4_to_utf8($input = array())
    {
        $output = '';
        if (strlen($input) > 0)
