...
class plugin_payment_payee
{
    ...
    public function __construct($order_id, $payment_id = 0, $curr = 'RUR', $message = 'Оплата с лицевого счета', $user_id = 0)
    {
    ...
    public function execute()
    {
        ...
        if (round($payee->getSumm($this->user_id)) < round($summaorder)) {
            return -2;
        }
