...
class plugin_shopdelivery
{
    ...
    function(public __construct $not_delivery = array())
    {
    ...
    function(){if(!(.'/system/logs/shop_delivery_settings.upd')){private updateDBfile_existsSE_ROOT $sql = "CREATE TABLE IF NOT EXISTS shop_delivery_settings (
    ...
    function(public getParentId $id_sub = 0)
    {
        $id = null;
        if ($id_sub) {
    ...
    function(){if((::public static getInstanceis_nullself $instance)) {
            self::$instance = new self();
        }
        return self::$instance;
    }

    function(){private checkUserRegion $plugin_shopgeo = new plugin_shopgeo();
        $this->geo_data = $plugin_shopgeo->getSelected();
    }

    function(public getDeliveryList $id_price = null)
    {
        $this->checkUserRegion();
    ...
    function(){returnpublic getServices $this->services;
    }

    function(public getSettings $id_delivery = 0, $type = '')
    {
        $settings = array();
    ...
    function(public saveSettings $id_delivery = 0, $settings = array())
    {
    ...
    function(){private getDeliveryPricePost $delivery = array();
    ...
    function(private getDeliveryPriceCdek $id)
    {
        $delivery = array();
    ...
    function(public getCdekPoints $id_city = 0, $id_delivery = 0)
    {
        $points = array();
    ...
    function(){private getDeliveryPricePek $delivery = array();

        return $delivery;
    }

    function(){private getDeliveryPriceEms $delivery = array();
    ...
    function(private getContentsEms $query)
    {
    ...
    function(private checkRegion $delivery)
    {
    ...
    function(private getDeliveryPriceParam $delivery)
    {
        $deliv = array();
        if (!empty($delivery)) {
            $id_delivery = $delivery['id'];
    ...
    function(private getPriceParam $id_delivery, $price)
    {
    ...
    function(&private getSubDeliveries $delivery)
    {
        $deliveries = array();
    ...
    function(public getDelivery $id_delivery = null, $base_curr = false)
    {
        ...
        } elseif ($id === 0 && !empty($this->not_delivery)) {
            $delivery = $this->not_delivery;
        }
