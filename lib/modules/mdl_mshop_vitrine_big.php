...
function module_mshop_vitrine_big( $razdel, $section = null ) {
    ...
    $analoggood = '';
    //нужно для определения осн. картинки от аналог. и сопут. товаров
    ...
    if ( isRequest( 'ajax'.$razdel ) ) {
        ...
        if ( isRequest( 'initvote' ) ) {
            ...
            echo intval( $psg->GoodsVotes( $viewgoods ) );
            //получить голос
            exit();
        }
        ...
        if ( seUserGroup() == 0 ) {
            ...
            if ( !empty( $vote ) ) {
                ...
                echo $psg->GoodsVotes( $viewgoods, $vote );
                //сохранить голос и возвратить текущий рейтинг
                exit();

            }
        } else {
            echo 'err_double_vote';
    ...
    if ( isRequest( 'jquery' . $razdel ) ) {
        if ( isRequest( 'idprice' ) ) {
            ...
            $_SESSION[ 'SHOP_VITRINE' ][ 'selected' ][ $price_id ][ $i_select ] = $this_id;
            ...
            //$cnt = $plugin_amount->showPresenceCount( $section->language->lang017 );
            // param69 - альтернативный текст 'Есть'
            ...
            $separator );
            // разделять ли пробелами 000 000
            ...
            if ( empty( $res_img[ 'imgparam' ] ) ) {
                ...
                if ( $goods[ 'img' ] != '' ) {
                    ...
                    list( $res_img[ 'imgparam1' ], ) = $psg->getGoodsImage( $goods[ 'img' ], intval( $section->parametrs->param293 ), 'w', $section->parametrs->param292 );
                    //$path_imgmain.$goods[ 'img' ];
                    ...
                    if ( $section->parametrs->param282 == 'N' ) {
                        $rezult = '<img class=\'goodsPhotoBig\' src=\' {
                            $res_img[ 'imgparam1' ]}
                            \' border=\'0\' title=\' {
                                $res_img[ 'imgparam_alt' ]}
                                \' alt=\' {
                                    $res_img[ 'imgparam_alt' ]}
                                    \'>';
                                }
                                if ( $section->parametrs->param282 == 'L' ) {
                                    $rezult = '<a class=\'cloud-zoom\' href=\' {
                                        $res_img[ 'imgparam1' ]}
                                        \' id=\'zoom1\' rel=\'position: 'right', adjustX: 10, adjustY: 0, showTitle: false, zoomWidth: ".$section->parametrs->param284."\">
                     <img class=\"goodsPhoto\' src=\' {
                                            $res_img[ 'imgparam_mid' ]}
                                            \' border=\'0\' alt=\' {
                                                $res_img[ 'imgparam_alt' ]}
                                                \' title=\' {
                                                    $res_img[ 'imgparam_alt' ]}
                                                ...
                                                if ( $section->parametrs->param282 == 'Z' ) {
                                                    $rezult = '<div id=\'photo\">
                     <a id=\"lightbox-foto1\' rel=\'lightbox-foto\' href=\' {
                                                        $res_img[ 'imgparam1' ]}
                                                        \' title=\' {
                                                            $res_img[ 'imgparam_alt' ]}
                                                            \">
                         <img class=\"goodsPhoto\' src=\' {
                                                                ...
                                                                $rezult = '<img class=\'goodsPhotoBig\' src=\' {
                                                                    ...
                                                                    \' border=\'0\' title=\' {
                                                                        ...
                                                                        list( $res_img[ 'imgparam1' ], ) = $psg->getGoodsImage( $res_img[ 'imgparam' ], intval( $section->parametrs->param293 ), 'w', $section->parametrs->param292 );
                                                                        //$path_imgall.$res_img[ 'imgparam' ];

                                                                        list( $res_img[ 'imgparam_mid' ], ) = $psg->getGoodsImage( $res_img[ 'imgparam' ], intval( $section->parametrs->param286 ), 'w', $section->parametrs->param292 );
                                                                        //"/lib/image.php?img={$res_img['imgparam']}&size={$section->parametrs->param286}";
                     ...
                     <a id=\"lightbox-foto1\' rel=\'lightbox-foto\' href=\' {
                         ...
                         <img class=\"goodsPhoto\' src=\' {
                                                                                                    ...
                                                                                                    */
                                                                                                    ...
                                                                                                    if ( $isSearchlist ) {
                                                                                                        // значит работаем с новым расширенным поиском
                                                                                                        ...
                                                                                                        if ( !empty( $_SESSION[ 'SHOP_VITRINE' ][ 'shopsearchingroup' ] ) ) {
                                                                                                            ...
                                                                                                            unset( $shopcatgr );
                                                                                                            // очищаем поисковые параметры модуля catalog
                                                                                                            if ( $searchingroup == -1 )
                                                                                                            $searchingroup = 0;
                                                                                                        } else
                                                                                                        $searchingroup = $shopcatgr;
                                                                                                        //getRequest( 'shopcatgr', 1 );
                                                                                                        ...
                                                                                                        if ( $searchingroup || ( $section->parametrs->param60 == 'Y' ) || $_SESSION[ 'CATALOGSRH' ][ 'manufacturer' ] ) {
                                                                                                            ...
                                                                                                            $searchingroup = join( ',', array_unique( $list ) );
                                                                                                            // $searchingroup превращается в array
                                                                                                            unset( $list );

                                                                                                        }
                                                                                                    } else {
                                                                                                        // значит работаем с каталогом - очищаем все поисковые параметры модуля searchlist

                                                                                                        unset( $_SESSION[ 'CATALOGSRH' ] );
                                                                                                        unset( $_SESSION[ 'SHOP_VITRINE' ][ 'shopsearchparams' ] );
                                                                                                        //  unset( $_SESSION[ 'SHOP_VITRINE' ][ 'ALL_SEARCH' ] );

                                                                                                        if ( empty( $shopcatgr ) && $base_group ) {
                                                                                                            // Если указана базовая группа, а $shopcatgr == 0, то берем базовую
                                                                                                    ...
                                                                                                    if ( isRequest( 'GoToComment' ) && seUserGroup() ) {
                                                                                                        ...
                                                                                                        if ( empty( $error_comm_message ) ) {
                                                                                                            $psg->saveGoodsComment( $viewgoods, $comm_note, $section->language->lang049 );
                                                                                                            //сохранить комментари в БД
                                                                                                            if ( !empty( $old_format ) ) {
