<?php
function module_abreadcrumbs($razdel, $section = null)
{
 ...
 if (strpos(dirname(__FILE__),'/lib/modules'))
   $__MDL_URL = 'lib/modules/abreadcrumbs';
 else $__MDL_URL = 'modules/abreadcrumbs';
 $__MDL_ROOT = dirname(__FILE__).'/abreadcrumbs';
