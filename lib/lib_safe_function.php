...
{
    if (preg_match(PREG_EXT, $source) || preg_match(PREG_EXT, $dest)) {
        exit('Access denied for copy PHP-files');
    } else {
...
{
    if (preg_match(PREG_EXT, $filename)) {
        exit('Access denied for read PHP-files');
    } else {
...
{
    if (preg_match(PREG_EXT, $filename) || preg_match(PREG_EXT, $dest)) {
        exit('Access denied for copy PHP-files');
    } else {
...
{
    if (preg_match(PREG_EXT, $oldname) || preg_match(PREG_EXT, $newname)) {
        exit('Access denied for rename PHP-files');
    } else {
