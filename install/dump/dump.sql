...
CREATE TABLE `shop_price` (
  ...
  `price_opt` double(10,2) NOT NULL,
  `price_opt_corp` double(10,2) NOT NULL,
  `price_purchase` decimal(10,2) unsigned DEFAULT NULL COMMENT 'Закупочная цена товара',
  `img` varchar(255) DEFAULT NULL,
  ...
  `min_count` double(10,3) NOT NULL,
  ...
  `vizits` int(10) unsigned NOT NULL,
  `is_market` tinyint(1) NOT NULL DEFAULT '1',
