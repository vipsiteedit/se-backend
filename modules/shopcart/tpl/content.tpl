...
<div class="content contShopCartNew" data-type="<?php echo $section->type ?>" data-id="<?php echo $section->id ?>" >
    ...
    <div class="contentBody" style="position:relative;">       
        <div id="notEmptyCartGoods" <?php if($total['count']==0): ?>style="display:none;"<?php endif; ?>>
            ...
            <form id="cartGoodsForm" style="margin:0px;" name="cartgoodsform" action="" method="post">     
                ...
                <div class="continueShoppingArea">
                    <a class="continueShopping btn btn-link" href="<?php echo $__data->getPagePattern($section->parametrs->param1) ?>"><?php echo $section->language->lang072 ?></a>
                </div>
        ...
        <div id="emptyCartGoods" <?php if($total['count']!=0): ?>style="display:none;"<?php endif; ?>>
            ...
            <a class="linkGoShopping" href="<?php echo $__data->getPagePattern($section->parametrs->param1) ?>"><?php echo $section->language->lang050 ?></a>
        </div>
    </div>
</div>
