            ...
            if ( SE_DB_ENABLE && $index ) {
                ...
                if ( strpos( $section->type, 'shop_groups' ) !== false || strpos( $section->type, 'vitrine' ) !== false ) {
                    ...
                    foreach ( $groups as $key => $code ) {
                        ...
                        if ( isset( $code[ 'created_at' ] ) && ( !isset( $code[ 'updated_at' ] ) || strtotime( $code[ 'updated_at' ] ) < 1000 ) ) $code[ 'updated_at' ] = $code[ 'created_at' ];
                        if ( !isset( $code[ 'updated_at' ] ) || strtotime( $code[ 'updated_at' ] ) < 1000 ) $code[ 'updated_at' ] = date( 'Y-m-d H:i:s' );
