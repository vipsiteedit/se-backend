...
se_db_query("ALTER TABLE `shop_stat_contact`
ADD CONSTRAINT `FK_shop_stat_contact_shop_stat_session_id` FOREIGN KEY (`id_session`) REFERENCES `shop_stat_session` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;");
...
se_db_query("ALTER TABLE `shop_stat_events`
ADD CONSTRAINT `FK_shop_stat_events_shop_stat_session_id` FOREIGN KEY (`id_session`) REFERENCES `shop_stat_session` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;");

se_db_query("ALTER TABLE `shop_stat_cart`
ADD CONSTRAINT `FK_shop_stat_cart_shop_stat_session_id` FOREIGN KEY (`id_session`) REFERENCES `shop_stat_session` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;");
...
se_db_query("ALTER TABLE `shop_stat_viewgoods`
ADD CONSTRAINT `FK_shop_stat_viewgoods_shop_stat_session_id` FOREIGN KEY (`id_session`) REFERENCES `shop_stat_session` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;");